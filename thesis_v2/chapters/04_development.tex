...
\noindent\emph{This appendix records how the control approach reached the
form reported in \cref{ch:method}, including the routes that were tried and
abandoned. It is a record of process rather than of result, which is why it
is here and not in the body.}
