# Simulation campaign 20260831_010704

Started 2026-08-31T01:07:04, finished 2026-08-31T01:28:24.

| stage | group | tier | status | s |
| --- | --- | --- | --- | --- |
| `teleop_orientation_cost` | teleoperation | stack | **ok** | 1238.6 |
...
```
  ...
  right +1+0+0   pinn 0.400(WEAR)  spin 0.400(WEAR)  cone 0.450(WEAR)  cone 0.575(WEAR)  free 0.625(WEAR)   +spin 0.000  +free 0.225
...
CONTROL 3: 1 comparison(s) EXCLUDED because the tighter policy hit the search cap, so its reach is a lower bound rather than a boundary:
    right -1-1+1  pinned 0.900 (CAPPED) vs spin 0.875
...
MEAN REACH over 28 walks
  ...
  cone45  0.530 m   (6 walks bound by the WEARER)
  free    0.547 m   (6 walks bound by the WEARER)

  unpinning the ROLL alone is worth +3 mm of mean reach
  a 45 deg cone is worth            +71 mm
  position only is worth            +87 mm
