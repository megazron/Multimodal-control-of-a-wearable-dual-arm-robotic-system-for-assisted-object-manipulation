...
\noindent\emph{The analysis that \cref{app:study} would be evaluated with,
written out, and measured against data whose answer was chosen. No
participant data exists; what is reported here is a property of the
procedure.}
