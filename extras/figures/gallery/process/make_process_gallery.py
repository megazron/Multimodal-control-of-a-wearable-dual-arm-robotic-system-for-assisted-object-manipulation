...
records: the 26 measurement defects (extras/figures/appendix/g_instrument.tex),
the git history, and the recording yield in recordings/sessions/.

    python3 extras/figures/gallery/process/make_process_gallery.py
"""
...
# ------------------------------------------------------- 1. the 26 defects
# Counts as stated in extras/figures/appendix/g_instrument.tex.
MECHANISM = [
