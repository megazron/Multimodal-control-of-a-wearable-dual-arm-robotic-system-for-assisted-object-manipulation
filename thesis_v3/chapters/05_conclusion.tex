...
A master was built and characterised, with six of fourteen channels alive
and the repair identified to two specific joints. The command mapping
degrades predictably: vertical and fore-aft motion track correctly on both
arms, lateral does not, and the measurements identify why no recalibration
can fix it. The safety architecture handled fourteen of fourteen injected
faults and makes every blocking mechanism observable by name. The workspace
characterisation found the two arms share no reachable point under the
as-built mount, identified a buildable mount correction, and that correction
was applied and re-verified. A verification methodology of ten repeats over
densified paths and known-answer instrument checks was applied throughout,
catching twenty-six measurement defects before they entered this report as
findings. And a first pilot of direct control against shared autonomy ran
under ethical approval with four operators across three tasks, showing
shorter completion times and fewer re-grips under assistance with no
measured cost in hand travel or responsiveness.

\section{What was not achieved}

No result in this report was validated on a physical Kinova arm carrying a
load. The full two-person study the architecture was designed around --
operator performance and wearer experience, measured together under the same
autonomy -- was not run; the pilot substitutes a smaller, operator-only
...
delivered and is not deliverable through this platform's available control
interface without a hardware change.
