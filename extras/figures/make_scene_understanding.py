...
Three stages, because MediaPipe and ultralytics live in different venvs:
  ...
  .venv_pose/bin/python   extras/figures/make_scene_understanding.py pose
  .venv_vision/bin/python extras/figures/make_scene_understanding.py detect
  python3                 extras/figures/make_scene_understanding.py compose
