...
SESSIONS = [
    ("Direct", "jorge_objecttrackingdirect_20260902_132710"),
    ("Shared autonomy", "jorge_objecttrackingshared_20260902_132941"),
]
HAND = "right"
ARM_LEN = 7
...
def load(session):
    path = os.path.join(ROOT, "recordings", "sessions", session, "trail_extracted.csv")
    with open(path) as f:
