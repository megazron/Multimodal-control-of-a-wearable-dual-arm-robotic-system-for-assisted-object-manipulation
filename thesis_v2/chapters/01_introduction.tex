...
analysis. \todo{CONFIRM: whether the divergence analysis is submitted as an
appendix or remains a supporting file.} The objectives below are the revised
...
twenty-five separate occasions, and validating the instrument first caught
...
wearer. \Cref{ch:motion} covers motion generation and what is known about
...
the two-person study in full and \cref{ch:participant} is where its results
will go. \Cref{ch:discussion} interprets the results and states the
