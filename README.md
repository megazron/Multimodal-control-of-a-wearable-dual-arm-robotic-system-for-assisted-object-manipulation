...
2026). The thesis itself is in `extras/figures/main.pdf`.
...
`extras/figures/make_cv_collage*.py` from
...
| `extras/figures/` | the scripts that regenerate every thesis figure from the recorded data |
