...
**Measured** 1280 x 720 px | focus (variance of Laplacian) 1141 | 8.58% of pixels clipped white, 1.95% crushed black
...
**Measured** median H 75  S 5  V 145 | 82.8% of pixels are below S=80 and cannot satisfy any colour term in this repository
...
**Measured** 1777 px selected (0.193% of the frame) | of those, median S 116 and median V 84
...
**Measured** 1777 px in, 501 px out, 1276 px removed (71.8%) | 137 separate blobs before, 1 after
...
**Measured** 1 components over 40 px | largest 501 px | this is where a MASK becomes a set of candidate OBJECTS
...
**Measured** white 283537 | black 201828 | cyan 45512 | red 9295 | green 574 | orange 496
...
**Measured** 21 x 22 px, 90.0 deg, aspect 1.05, identity (not measured)
...
**Measured** 109 regions | largest 228216 px (24.8% of frame), smallest 57 px
...
**Measured** 109 in, 108 kept, 1 too small, 0 too large
...
**Measured** 598 px at (612, 442), mean BGR [105.1, 139.3, 74.0]
