...
\cref{tab:instr2} the nine recorded afterwards, during the perception, motion
...
Sorted by mechanism rather than by symptom, the twenty-five fall into four
...
\begin{table}[htbp]
  \centering
  \caption{What revealed each of the twenty-five.}
  \label{tab:caught}
  \begin{tabular}{@{}lr@{}}
    \toprule
    Revealed by & Cases \\
    \midrule
    An independently known quantity contradicting the reading & \textbf{14} \\
