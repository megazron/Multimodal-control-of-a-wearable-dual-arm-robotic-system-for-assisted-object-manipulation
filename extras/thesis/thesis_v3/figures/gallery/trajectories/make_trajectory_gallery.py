...
Two phases, so the plots can be re-drawn without ROS:
    ...
    python3 extras/thesis/thesis_v3/figures/gallery/trajectories/make_trajectory_gallery.py extract
    python3 extras/thesis/thesis_v3/figures/gallery/trajectories/make_trajectory_gallery.py plot
