...
recordings and the other non-pilot recordings.
    ...
    python3 extras/thesis/thesis_v3/figures/gallery/verification/make_verification_gallery.py
...
def fig_placement_history():
    sets = [("2026-08-13, first spec", "extras/archive/recordings/superseded_20260813_prespec/verification/accuracy_table.json"),
            ("2026-08-11 rework", "extras/archive/recordings/superseded_20260813_prespec/verification_20260811_t1rework/accuracy_table.json"),
    ...
    save(fig, "08_placement_error_history", "How far each cube was set down from its pad, across the four recorded versions of the pick-and-place",
         "extras/archive/recordings/*/accuracy_table.json and recordings/verification/accuracy_table.json (06_full_autonomy, t1, place_err)",
