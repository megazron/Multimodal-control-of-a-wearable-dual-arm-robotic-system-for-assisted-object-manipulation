...
The fifth arose from necessity. Across this project, results that looked like
system failures turned out four separate times to be defects in the measuring
tool, and validating the instrument first caught errors that would otherwise
have entered the record as findings. It is the most transferable outcome of
the work.

\section{Thesis structure}

\Cref{ch:background} reviews the field by theme and ends with the gap this
work addresses. \Cref{ch:master} documents the master arm: its electronics,
its firmware and its mechanical build. \Cref{ch:development} records how the
...
characterisation on its own, because it is a chain of measurements whose
consequences determine the shape of the task set. \Cref{ch:discussion}
interprets the results and states the limitations. \Cref{ch:conclusion}
sets out what would most improve the system.
