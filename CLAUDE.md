...
| clips | the 2026-08-16 set (25 cells, three routines, eight angles, a card each) is superseded by the 2026-08-23 re-record above and archived in `archive/recordings/verification_20260815_part6`, which is still the evidence for finding 3 | `scripts/status_table.py` |
