...
records: the 26 measurement defects (thesis_v3/appendix/g_instrument.tex),
the git history, and the recording yield in recordings/sessions/.

    python3 thesis_v3/figures/gallery/process/make_process_gallery.py
"""
...
# ------------------------------------------------------- 1. the 26 defects
# Counts as stated in thesis_v3/appendix/g_instrument.tex.
MECHANISM = [
