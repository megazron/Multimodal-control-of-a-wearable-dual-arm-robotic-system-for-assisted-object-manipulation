...
Regenerate: `python3 extras/figures/gallery/process/make_process_gallery.py`.
...
| --- | --- | --- | --- | --- | --- |
| `instrument_defects` | The 26 times a measurement was wrong and the system was not: what went wrong, and how it was caught | counts as stated in `extras/figures/appendix/g_instrument.tex` (mechanism groups 7/6/5/5/3; catch routes 15/5/6) | Care did not catch them; a second, independent number did — 15 of 26 were caught by a known quantity disagreeing with the reading. | 26 cases; 15 caught by an independent quantity, 5 by reading code, 6 by looking at the raw artefact | **MAIN** candidate for Discussion §Validity (the two numbers that section already carries in words, as a picture; costs one figure slot and ~0 words) |
