...
Three stages, because MediaPipe and ultralytics live in different venvs:
  ...
  .venv_pose/bin/python   thesis_v3/figures/make_scene_understanding.py pose
  .venv_vision/bin/python thesis_v3/figures/make_scene_understanding.py detect
  python3                 thesis_v3/figures/make_scene_understanding.py compose
