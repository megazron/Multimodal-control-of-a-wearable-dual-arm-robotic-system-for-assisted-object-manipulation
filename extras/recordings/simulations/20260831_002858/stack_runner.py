...
STAGES = json.loads('[{"key": "teleop_orientation_cost", "title": "What the pinned wrist costs", "group": "teleoperation", "tier": "stack", "argv": ["/usr/bin/python3", "scripts/measure_orientation_cost.py", "--dirs", "14", "--arm", "both", "--seeds", "10"], "produces": ["recordings/baselines/orientation_cost.json"], "timeout": 5400, "note": "mean reach per direction under each orientation policy"}]')
OUT = '/home/gausms/kortex_ws/recordings/simulations/20260831_002858'
