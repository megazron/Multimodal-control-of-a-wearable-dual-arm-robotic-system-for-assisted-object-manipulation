...
\todo{CONFIRM: dates and durations of the simulation phase with Dr.\ Zhang.
The sequence below is accurate; the calendar is reconstructed from repository
history and supervision notes rather than from a contemporaneous log.}
