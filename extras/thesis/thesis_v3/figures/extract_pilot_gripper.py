...
record rather than from memory.
    ...
    python3 extras/thesis/thesis_v3/figures/extract_pilot_gripper.py  [session_dir ...]

Output: extras/thesis/thesis_v3/figures/pilot/data/gripper_by_session.jsonl (appended,
