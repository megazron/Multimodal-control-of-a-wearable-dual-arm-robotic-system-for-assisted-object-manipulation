...
| T1 | stage 1 is the **LEFT** arm, cubes on the left. **Re-verified 2026-08-17 at the solved home: 0 IK failures and 0 waypoints inside the floor over 7522 IK calls**, stage 1 AND all three stage-2 seeds, both controls correct. Seed 0's 25-of-98 floor breach was the 2026-08-15 home and is CLOSED | `scripts/verify_t1_paths.py` |
